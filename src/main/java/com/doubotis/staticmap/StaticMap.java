...
public class StaticMap {
    ...
    /**
     * Sets a custom projection. A projection is used to compute relations between
     * real locations and positions on the final picture. See
     * {@link MercatorProjection}.
     */
     ...
     * between real locations and positions on the final picture. See
     * {@link MercatorProjection}.
     */
    ...
    /**
     * Runs the procedure of drawing. Stores the result into the specified
     * {@link File}.
     */
    ...
    /**
     * Adds a {@link Layer} onto the map. The layer will be drawn from the first to
     * the last. For instance, you can add any {@link BaseMapType}, {@link TMSLayer}
     * or {@link WMSMapType} object.
     */
    ...
    /**
     * Inserts a {@link Layer} onto the map at the specified index. The layer will
     * be drawn from the first to the last. For instance, you can add any
     * {@link BaseMapType}, {@link TMSLayer} or {@link WMSMapType} object.
     */
    ...
    /**
     * Removes the spceified {@link Layer} from the map. The removed layer will not
     * been drawn anymore.
     */
     ...
     * sets location and zoom level depending on the size of the final picture and
     ...
     * sets location and zoom level depending on the size of the final picture and
     * the specified bounds.<br/>
     * You can specify a padding to apply to the map. This doesn't means the padding
     * will be exactly matching, but while computing the right zoom, the padding
     * will be taken in account in order to not allowing space in each side, lower
     * than this padding.
     */
